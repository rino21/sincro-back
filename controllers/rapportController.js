...
const createRapport = async (req, res) => {
  try {
    ...
    await Historique.logAction(req.params.membre_id, 'create', 'Rapport', rapp_id);
...
const updateRapport = async (req, res) => {
  try {
    ...
    await Historique.logAction(req.params.membre_id, 'update', 'Rapport', req.params.id);
...
const deleteRapport = async (req, res) => {
  try {
    ...
    await Historique.logAction(req.params.membre_id, 'delete', 'Rapport', req.params.id);
